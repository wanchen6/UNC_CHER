...
def main():
    ...
    try:
        ...
        if html_body_email == None or html_body_wordpress == None:
            ...
            html_body_email = '''\n\t<body style="margin:0; font:300 1em/2em 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; color:#666; text-decoration: none;">\n\t\t<div style="width:100%; text-align:center;">\n\t\t\t<a href="*|ARCHIVE|*" style="text-decoration: none; color: #56a0d3; font-size: 12px; ">This email contains images. View this email in your browser</a>\n\t\t</div>\n\t\t<div style="text-align: center; margin: 10px;">\n\t\t\t<a href="https://cher.unc.edu/"><img class="image-inline" title="" alt="" src="https://cher.unc.edu/files/2014/03/cher-logo.jpg"></a>\n\t\t</div>\n\t\t<ul style ="margin:0; width: 100%; background-color: rgba(86,160,211,1); margin-bottom: 0; padding-left: 0; text-align: center;">\n\t\t\t<li style="display:inline-block; margin:1em 2em;"><a href="#event" style="text-decoration: none; color: #fff;">Events</a></li>\n\t\t\t<li style="display:inline-block; margin:1em 2em;"><a href="#associate" style="text-decoration: none; color: #fff;">Our Associates</a></li>\n\t\t\t<li style="display:inline-block; margin:1em 2em;"><a href="#funding" style="text-decoration: none; color: #fff;">Funding Opportunities</a></li>\n\t\t</ul>\n\t\t<div class="header-image" style="background-image: url('https://cher.unc.edu/files/2015/05/About-Us-photo.jpg'); background-size:cover; width:100%; height:400px;margin:0;">\n\t\t</div>'''+html_body_email+'\n\t</body>'
    ...
    for row in csv_content:
        ...
        if category_content == 'Event':
            ...
            if mydate <= date.today():
                ...
                # Add title
                title_html = '\n\t\t\t\t<h1 class="title" style="font-weight: 400; margin: 0.5em 0 0.5em 0; clear: both; font-size:1.5em;"><a href="' + post_url_content + '" style="text-decoration: none; color: #56a0d3; ">' + title_content + '</a></h1>'

                # Add date
                date_html = '\n\t\t\t\t<h3 class="date" style="font-weight: 400; margin: 0 0 0.5em 0; font-size: 1.1em;">' + event_date_content + '</h3>'

                # Add location or award
                location_award_html = '\n\t\t\t\t<h3 class="location-award" style="font-weight: 400; margin: 0 0 0.5em 0; font-size: 1.1em;">Location: ' + location_content + '</h3>'
            ...
            if final_txt_content != '':
                ...
                # Add date
                date_html = '\n\t\t\t\t<h3 class="date" style="font-weight: 400; margin: 0 0 0.5em 0; font-size: 1.1em;">Deadline: ' + apply_date_content + '  '+ dead_time_content + '<a href="' + dead_url_content + '" style="text-decoration: none; color:#56a0d3;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Register Now</a></h3>'
            ...
            if institution_content == funding_inst:
                ...
                abstract_html = '\n\t\t\t\t<p class="abstract" style="font-weight: 300; line-height: 1.5em; margin:0;"><a href="' + post_url_content + '" style="text-decoration: none; color: #56a0d3;">' + title_content + '</a>&nbsp;&nbsp;&nbsp;Deadline: ' + apply_date_content + '  '+ dead_time_content + '<a href="' + dead_url_content + '" style="text-decoration: none; color: #56a0d3;">&nbsp;&nbsp;&nbsp;Register Now</a>&nbsp;&nbsp;&nbsp;Funding: ' + award_amt_content + '</p>'
                ...
                # Add title
                title_html = '\n\t\t\t\t<h1 class="title" style="font-weight: 400; margin: 0.5em 0 0.5em 0; clear: both; font-size:1.5em;"><a href="' + inst_url_content + '" style="text-decoration: none; color: #56a0d3; ">' + institution_content + '</a></h1>'
            ...
            if mydate < date.today() - timedelta(days=30):
                ...
                # Add location or award
                location_award_html = '\n\t\t\t\t<h3 class="location-award" style="font-weight: 400;margin: 0 0 0.5em 0; font-size: 1.1em;">Institution: <a href="'+ inst_url_content +'" style="text-decoration: none; color: #56a0d3;">' + institution_content + '</a></h3>'
