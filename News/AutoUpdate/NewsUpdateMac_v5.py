...
def read_content(csv_content):
    ...
    event_html_wp = '[tab title="Upcoming Events" active="active"]'
    funding_html = '<section id="funding" class="offset" style="margin: 0 20px;"><h1 class="news-title" style="color: #fff; font-size: 2em; margin-top: 0; margin-bottom: 0.5em; margin-left: -20px; margin-right: -20px; padding: 0.5em; background-color: rgba(86,160,211,0.5);">Funding</h1>'
    ...
    associate_html = '<section id="associate" class="offset" style="margin: 0 20px;"><h1 class="news-title" style="color: #fff; font-size: 2em; margin-top: 0; margin-bottom: 0.5em; margin-left: -20px; margin-right: -20px; padding: 0.5em; background-color: rgba(86,160,211,0.5);">Our Associates</h1>'
    associate_html_wp = '[tab title="Our Associates"]'
    other_html = '<section id="other" class="offset" style="margin: 0 20px;"><h1 class="news-title" style="color: #fff; font-size: 2em; margin-top: 0; margin-bottom: 0.5em; margin-left: -20px; margin-right: -20px; padding: 0.5em; background-color: rgba(86,160,211,0.5);">Our Trainees</h1>'
        ...
        if category_content == 'Event':
            ...
            if mydate < date.today():
                ...
                if img_url_content == '':
                    ...
                    abstract_html = '<span><img src="' + img_url_content + '"  style="max-width: 33%; min-width:auto; max-height: 200px; float: left; margin-bottom: 1em; margin-right: 1em;"><p class="abstract" style="line-height: 1.5em">' + final_txt_content + '</p></span>'
